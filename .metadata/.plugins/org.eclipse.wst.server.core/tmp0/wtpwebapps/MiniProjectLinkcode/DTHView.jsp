...
<div class="container1">
	...
	<div class="form-container">
		...
		<div class="DTH-ope">
			...
			<select name="operator" id="sub" required>
	     ...
	     <div class="cons-no">
	        <input type="text" name="consumerNo" placeholder="Enter Consumer Number" required maxlength="10" pattern="\d{10}"
							title="Account number must be 10 digits"/>
	        <input type="number" name="amt" placeholder="Enter Amount" required min="50" step="0.01"/>
	     </div>
	     <div class="payment">
	...
	<img src="./images/dthtv.svg" alt="dth recharge svg">
</div>	
</body>
</html>