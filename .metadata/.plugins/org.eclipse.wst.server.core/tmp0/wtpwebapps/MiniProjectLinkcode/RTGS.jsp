...
<div class="container">
		...
		<div class="header">
			<h1>Real Time Gross Settlement</h1>
		</div>
		<form action="NEFTController">
			...
			<div class="amount">
				...
				<input type="number" name="amount" placeholder="Enter amount to transfer" min="200000"required>
			</div>
			<div class="payment">
	...
	<img src="rtgs.jpg" alt="RTGS Transfer">
</div>
</body>
</html>